...
public class CmdPaintParser extends Parser {
	...
	public static final int
		...
		SERIALIZE=16, GROUP=17, DEGROUP=18, LOAD=19, CLONE=20, SCALE=21, SQUARE=22, 
		CIRCLE=23, RECTANGLE=24, POLYGON=25, LINE=26, SIZE=27, LENGTH=28, RADIUS=29, 
		WIDTH=30, HEIGHT=31, HOLLOW=32, SAVE=33, DOWN=34, UP=35, STROKE=36, ALL=37, 
		IMAGE=38, SCRIPT=39, LPAREN=40, RPAREN=41, COMMA=42, COLOR=43;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'load'", "'clone'", "'scale'", null, null, null, null, "'line'", null, 
			"'length'", null, null, null, "'hollow'", "'save'", "'down'", "'up'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SERIALIZE", "GROUP", "DEGROUP", "LOAD", "CLONE", "SCALE", "SQUARE", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 81608572896L) != 0) );
			setState(31);
			match(EOF);
			}
		}
